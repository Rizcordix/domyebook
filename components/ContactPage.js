          ...
          <div className="row justify-content-center">
            <div className="col-xl-10">
              ...
              <div className="mil-mb-80">
                ...
                <div className="row">
                  {[
                    { icon: '✍️', title: 'Ebook Writing & Ghostwriting', desc: 'Professional writers to bring your ideas to life' },
                    { icon: '✏️', title: 'Editing & Proofreading', desc: 'Polish your manuscript to perfection' },
                    { icon: '🎨', title: 'Book Cover Design', desc: 'Eye-catching covers that sell books' },
                    { icon: '📚', title: 'Publishing & Distribution', desc: 'Get your ebook on all major platforms' },
                    { icon: '📈', title: 'Marketing & Promotion', desc: 'Strategies to boost your book sales' },
                    { icon: '💬', title: 'Publishing Consultation', desc: 'Expert advice for your publishing journey' }
                  ].map((service, index) => (
